"""
Main file for running the Real Time verification.
"""
import pandas as pd
...
nb_scn_rt = 2 # Nb of realizations used to evaluate the real time costs
...
if __name__ == '__main__':
    ...
    for a in accepted_files:
        for t in test_cases:
            accepted = pd.read_csv('{} Data/{}_{}_accepted_{}.csv'.format(case_name,case_name,t,a))
            accepted_offers = accepted[accepted['Type']=='Offer']
            print()
            print('Currently calculating: ',a,t)
            print()
